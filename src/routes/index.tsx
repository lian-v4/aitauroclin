        ...
        <div className="md:col-span-5 lg:col-span-5">
          <figure className="relative">
            ...
            <img
              ...
              className="relative w-full aspect-[4/5] object-cover [object-position:38%_18%] img-fade-radial"
              loading="eager"
            />
          </figure>
        </div>
        ...
        <aside className="md:col-span-4">
          <div className="md:sticky md:top-32">
            ...
            <img
              ...
              className="w-full aspect-[4/5] object-cover [object-position:62%_15%] mb-8 img-fade-b"
              loading="lazy"
            />
