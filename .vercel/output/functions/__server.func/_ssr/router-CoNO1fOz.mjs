...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CoNO1fOz.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-7phShhRl.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Centro de excelência em urologia e saúde masculina. Atendimento de alta precisão em São Paulo."
			},
			{
				name: "author",
...
var $$splitComponentImporter = () => import("./routes-BkWMeZyg.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "Dr. Giuliano Aita — Urologia & Saúde do Homem" },
		{
			name: "description",
			content: "Centro de excelência em urologia, andrologia e saúde sexual masculina. Atendimento de alta precisão pelo Dr. Giuliano Aita em São Paulo."
		},
		{
			property: "og:title",
			content: "Dr. Giuliano Aita — Urologia & Saúde do Homem"
		...
		{
			property: "og:description",
			content: "Centro de excelência em urologia, andrologia e saúde sexual masculina. Atendimento de alta precisão em São Paulo."
		},
		{
			property: "og:image",
